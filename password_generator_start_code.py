...
# Set Accumulator for Password Characters List #accumaulators stores only of the same type(List)
...
Final_password_list = password_digits_list + password_character_list + password_symbols_list
...
print('This is your default password:' + string_password)